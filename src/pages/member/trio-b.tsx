...
export default function TrioPlayerBPage() {
  ...
  async function loadTrioPlayer() {
    ...
    try {
      ...
      if (trioRecord?.player2) {
        setPlayerName(trioRecord.player2.username);
      } else {
      ...
      <div className="container mx-auto p-4 max-w-4xl">
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            <Badge className="bg-blue-500 text-white px-4 py-2 text-lg">PLAYER B</Badge>
            <Trophy className="w-6 h-6 text-blue-500" />
          </div>
          <h1 className="text-3xl font-bold text-gray-900">Undi Lane - Trio Player B</h1>
          <p className="text-muted-foreground mt-1">Roda undian khas untuk Player B</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="font-semibold text-blue-900">Player B:</span>
              </div>
              <div className="text-2xl font-bold text-blue-600">{playerName}</div>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-8">
          <div className="flex flex-col items-center">
            <div className="relative w-72 h-72 mb-8">
              <div
                ref={wheelRef}
                className="w-full h-full rounded-full border-8 border-blue-500 bg-gradient-to-br from-blue-400 to-blue-600 shadow-2xl flex items-center justify-center transition-transform"
                style={{ transitionDuration: "0ms" }}
              >
                <div className="text-white text-6xl font-bold">🎳</div>
              </div>
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-0 h-0 border-l-[20px] border-r-[20px] border-t-[40px] border-l-transparent border-r-transparent border-t-blue-800 z-10"></div>
            </div>

            {result && (
              <div className="mb-6 text-center animate-bounce">
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl p-6 shadow-xl">
            ...
            <Button
              ...
              size="lg"
              className="bg-blue-600 hover:bg-blue-700 text-white px-12 py-6 text-xl font-bold rounded-xl shadow-lg"
            >
              {spinning ? (
                <>
