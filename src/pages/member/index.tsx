      ...
      <div className="min-h-screen bg-gray-50">
              ...
              <div className="flex items-center gap-4">
                <Link href="/member/profile">
                  {memberData?.avatar_url ? (
                    ...
                    <div className="w-10 h-10 rounded-full bg-red-600 flex items-center justify-center border-2 border-red-600">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="space-y-8">
            {/* Welcome Message */}
            <Card className="bg-gradient-to-r from-red-50 to-white border-gray-200 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card className="bg-white border-gray-200 shadow-sm">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-gray-600 text-sm">Purata Skor</p>
              ...
              <Card className="bg-white border-gray-200 shadow-sm">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-gray-600 text-sm">Kedudukan</p>
                      <p className="text-3xl font-bold text-gray-900">#{stats.currentRank}</p>
                    </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              <Link href="/member/blok">
                <Card className="bg-white border-gray-200 shadow-sm hover:shadow-md hover:border-red-600 transition-all cursor-pointer h-full">
                  <CardContent className="p-6 flex flex-col items-center justify-center text-center gap-3">
                    <Trophy className="h-12 w-12 text-red-600" />
                    <h3 className="text-lg font-bold text-gray-900">BLOK</h3>
                    <p className="text-xs text-gray-600">Leaderboard</p>
                  </CardContent>
                </Card>
              </Link>

              <Card className="bg-gray-100 border-gray-300 opacity-60 cursor-not-allowed h-full">
                <CardContent className="p-6 flex flex-col items-center justify-center text-center gap-3">
              ...
              <Link href="/member/hall-of-fame">
                <Card className="bg-white border-gray-200 shadow-sm hover:shadow-md hover:border-red-600 transition-all cursor-pointer h-full">
                  <CardContent className="p-6 flex flex-col items-center justify-center text-center gap-3">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">HALL OF FAME</h3>
