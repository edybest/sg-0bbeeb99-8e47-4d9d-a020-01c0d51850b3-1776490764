        ...
        <MemberLayout>
            <>
                ...
                <Dialog open={isTrioDialogOpen} onOpenChange={setIsTrioDialogOpen}>
                    <DialogContent className="max-w-[95vw] sm:max-w-2xl max-h-[80vh] overflow-y-auto p-0 bg-slate-50 border-0 rounded-2xl sm:rounded-3xl shadow-2xl [&>button]:hidden">
