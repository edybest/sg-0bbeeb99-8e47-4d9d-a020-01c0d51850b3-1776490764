            ...
            <>
                ...
                <Dialog open={isMenVsWomenDialogOpen} onOpenChange={setIsMenVsWomenDialogOpen}>
                    ...
                    >
                        <div
                            ref={menVsWomenRef}
                            className={`bg-slate-50 ${isCapturingScreenshot ? "overflow-visible" : ""}`}
                        >
                            <div
                                                ...
                                                <div className="relative z-10">
                                                    <div className="flex items-center justify-between mb-4">
                                                        <div className="flex items-center gap-3 min-w-0">
                                                            <div
                                                                className={`w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center text-2xl sm:text-3xl ${menVsWomenData.menTotal > menVsWomenData.womenTotal
                                                                        ? "bg-white/20"
                                                        ...
                                                        <div
                                                            className={`text-3xl sm:text-6xl font-black leading-none ${menVsWomenData.menTotal > menVsWomenData.womenTotal
                                                                    ? "text-white"
                                                                    : "text-blue-600"
                                                                }`}
                                                        >
                                            ...
                                            >
                                                <div className="relative z-10">
                                                    <div className="flex items-center justify-between mb-4">
                                                        <div className="flex items-center gap-3 min-w-0">
                                                            <div
                                                                className={`w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center text-2xl sm:text-3xl ${menVsWomenData.womenTotal > menVsWomenData.menTotal
                                                                        ? "bg-white/20"
                                                        ...
                                                        <div
                                                            className={`text-3xl sm:text-6xl font-black leading-none ${menVsWomenData.womenTotal > menVsWomenData.menTotal
                                                                    ? "text-white"
                                                                    : "text-pink-600"
                                                                }`}
                                                        >
