...
import { Trophy, Target, Loader2, LogOut, BarChart3, User, Users, LayoutGrid, Shuffle } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <PageAccessGuard pagePath="/" requireAuth={false}>
      <>
        <SEO 
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    <div className="flex-1">
                      ...
                      {!member && (
                        <p className="text-red-100">
                          Explore our bowling club features
                        </p>
                      )}
                    </div>
                    <ClubLogo size="xl" />
